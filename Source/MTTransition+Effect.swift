...
extension MTTransition {
    ...
    public enum Effect: CaseIterable, CustomStringConvertible {
        ...
        public var image: String {
            ...
            case .directionalScaled: return "ic_directionalscaled"
            ...
            case .horizantalClose: return "ic_horizantalclose"
            case .horizantalOpen: return "ic_horizantalopen"
            case .verticalClose: return "ic_verticalclose"
            case .verticalOpen: return "ic_verticalopen"
            case .simpleZoomOut: return "ic_simplezoomout"
            case .rectangleCrop: return "ic_rectangle_crop"
            case .rotateScaleVanish: return "ic_rotatescale_vanish"
            case .rotateScaleVanishReverse: return "ic_rotatescale_vanish_reverse"
            case .dissolve: return "ic_dissolve"
            case .XTranslation: return "ic_xtranslation"
            case .SplitSlideInHorizontal: return "ic_splitslide_in_horizontal"
            case .SplitSlideInOutHorizontal: return "ic_splitslide_in_out_horizontal"
            case .SplitSlideInVertical: return "ic_splitslide_in_vertical"
            case .SplitSlideInOutVertical: return "ic_splitslide_in_out_vertical"
            case .SplitSlideOutHorizontal: return "ic_splitslide_out_horizontal"
            case .SplitSlideOutVertical: return "ic_splitslide_out_vertical"
            case .AngleSlice: return "ic_angleslice"
            case .Bar: return "ic_bar"
            case .BokehBlend: return "ic_bokehblend"
            case .CirclePinchWarp: return "ic_circlepinchwarp"
            case .DiagonalGlitch: return "ic_diagonalglitch"
            case .DotTrans: return "ic_dottrans"
            case .FireWipe: return "ic_firewipe"
            case .GrowingSquares: return "ic_growingsquares"
            case .RandomSlide: return "ic_randomslide"
            case .AlanRipple: return "ic_alanripple"
            case .SideNoise: return "ic_Side_noise"
            case .DispCurious: return "ic_dispcurious"
            case .DispCurious1: return "ic_dispcurious1"
            case .DispCurious2: return "ic_dispcurious2"
            case .DispCurious3: return "ic_dispcurious3"
            case .DispCurious4: return "ic_dispcurious4"
            case .ZoomInOut: return "ic_zoominout"
            case .bookFlip: return "ic_bookflip"
            case .YTranslation: return "ic_ytranslation"
            case .DispCurious5: return "ic_dispcurious5"
            case .DispCurious6: return "ic_dispcurious6"
            case .DispCurious7: return "ic_dispcurious7"
            case .DispCurious8: return "ic_dispcurious8"
            case .DispCurious9: return "ic_dispcurious9"
            case .DispCurious10: return "ic_dispcurious10"
            case .DispCurious11: return "ic_dispcurious11"
            case .DispCurious12: return "ic_dispcurious12"
            case .perlinSwipe: return "ic_perlinswipe"
            case .chiasm: return "ic_chiasm"
            case .honeyComb: return "ic_honeycomb"
            }
        }
    }
}
